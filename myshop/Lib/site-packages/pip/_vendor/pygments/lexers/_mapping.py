...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML + Angular2', ('img+ng2',), ('*.ng2',), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Cheetah', ('img+cheetah', 'img+spitfire', 'htmlcheetah'), (), ('text/img+cheetah', 'text/img+spitfire')),
    ...
    'DtdLexer': ('pip._vendor.pygments.lexers.img', 'DTD', ('dtd',), ('*.dtd',), ('application/xml-dtd',)),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Evoque', ('img+evoque',), ('*.img',), ('text/img+evoque',)),
    ...
    'HTMLUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'HTML+UL4', ('img+ul4',), ('*.htmlul4',), ()),
    'HamlLexer': ('pip._vendor.pygments.lexers.img', 'Haml', ('haml',), ('*.haml',), ('text/x-haml',)),
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Handlebars', ('img+handlebars',), ('*.handlebars', '*.hbs'), ('text/img+handlebars', 'text/x-handlebars-template')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Django/Jinja', ('img+django', 'img+jinja', 'htmldjango'), ('*.img.j2', '*.htm.j2', '*.xhtml.j2', '*.img.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/img+django', 'text/img+jinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Genshi', ('img+genshi', 'img+kid'), (), ('text/img+genshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.img', 'HTML', ('img',), ('*.img', '*.htm', '*.xhtml', '*.xslt'), ('text/img', 'application/xhtml+xml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+PHP', ('img+php',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Smarty', ('img+smarty',), (), ('text/img+smarty',)),
    ...
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Lasso', ('img+lasso',), (), ('text/img+lasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    ...
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Mako', ('img+mako',), (), ('text/img+mako',)),
    ...
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Myghty', ('img+myghty',), (), ('text/img+myghty',)),
    ...
    'PugLexer': ('pip._vendor.pygments.lexers.img', 'Pug', ('pug', 'jade'), ('*.pug', '*.jade'), ('text/x-pug', 'text/x-jade')),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers.templates', 'RHTML', ('rhtml', 'img+erb', 'img+ruby'), ('*.rhtml',), ('text/img+ruby',)),
    ...
    'ScamlLexer': ('pip._vendor.pygments.lexers.img', 'Scaml', ('scaml',), ('*.scaml',), ('text/x-scaml',)),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Twig', ('img+twig',), ('*.twig',), ('text/img+twig',)),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Velocity', ('img+velocity',), (), ('text/img+velocity',)),
    ...
    'XmlLexer': ('pip._vendor.pygments.lexers.img', 'XML', ('xml',), ('*.xml', '*.xsl', '*.rss', '*.xslt', '*.xsd', '*.wsdl', '*.wsf'), ('text/xml', 'application/xml', 'image/svg+xml', 'application/rss+xml', 'application/atom+xml')),
    ...
    'XsltLexer': ('pip._vendor.pygments.lexers.img', 'XSLT', ('xslt',), ('*.xsl', '*.xslt', '*.xpl'), ('application/xsl+xml', 'application/xslt+xml')),
